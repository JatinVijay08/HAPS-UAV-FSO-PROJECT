...
% RECEIVER NOISE
%
% Generate one noise realization for this simulation
%% =========================================================

Nsamples = length(rxOpticalSignal);

receiverNoise = ...
params.sigmaNoise * randn(size(rxOpticalSignal));
...
results.receiverNoise = receiverNoise;
...
% Combined per-bit channel gain
results.H_channel_bits = ...
    results.H_total .* ...
    results.H_point_bits .* ...
    results.H_turb_bits;
